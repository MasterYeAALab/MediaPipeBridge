...
class MainWindow(QMainWindow):
    ...
    def _features_group(self) -> QGroupBox:
        ...
        self.max_hands.setRange(1, 10)
        self.max_hands.setValue(2)
        self.max_faces = QSpinBox()
        self.max_faces.setRange(1, 10)
        self.max_faces.setValue(1)

        layout.addWidget(QLabel("Max Hands:"), 9, 0)
        layout.addWidget(self.max_hands, 9, 1)
        layout.addWidget(QLabel("Max Faces:"), 10, 0)
        layout.addWidget(self.max_faces, 10, 1)
    ...
    def _read_config(self) -> AppConfig:
        return AppConfig(
            ...
            features=FeatureConfig(
                ...
                max_hands=self.max_hands.value(),
    ...
    def load_settings(self) -> None:
        ...
        try:
            ...
            self.max_hands.setValue(data.get("max_hands", 2))
            self.max_faces.setValue(data.get("max_faces", 1))
