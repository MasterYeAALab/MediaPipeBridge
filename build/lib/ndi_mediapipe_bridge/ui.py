...
class GestureManagerDialog(QDialog):
    ...
    def _on_delete(self):
        ...
        self.library.save("custom_gestures.json")
        self._refresh_list()
...
class MainWindow(QMainWindow):
    def __init__(self) -> None:
        super().__init__()
        self.setWindowTitle("NDI MediaPipe Bridge")
        self.resize(1280, 850)
        
        self.gesture_library = GestureLibrary()
        self.gesture_library.load("custom_gestures.json")
...
def run_app() -> int:
    ...
    font_path = "/Users/masteryeeeee/Documents/New project/ndi-mediapipe-bridge/Font/XQJF.ttf"
